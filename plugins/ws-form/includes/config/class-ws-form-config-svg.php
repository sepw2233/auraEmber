		...
		public static function get_icon_16_svg($id = '') {
			...
			switch($id) {
				...
				case 'hash' :
					...
					$return_value = '<path d="m6.6 6.4-.4 3.2h3.2l.3-3.2H6.6zm.1-1.6h3.2l.5-4.8H12l-.5 4.8h3.7L15 6.4h-3.7L11 9.6h3.4l-.2 1.6h-3.4l-.4 4.8H8.8l.5-4.8H6.1L5.6 16H4l.5-4.8H.8L1 9.6h3.7L5 6.4H1.6l.2-1.6h3.4L5.6 0h1.6l-.5 4.8z"/>';
					break;
				...
				case 'markup' :
					...
					$return_value = '<path d="M5.8 5.6 1.9 8l4 2.4v2.5L0 9.1V6.9l5.7-3.8v2.5h.1zm1.7 9H6.3L8.5 1.4h1.2L7.5 14.6zm2.7-1.7v-2.5l4-2.4-4-2.4V3.1L16 6.9V9c0 .1-5.8 3.9-5.8 3.9z"/>';
					break;
				...
				case 'scheme_alt' :
					...
					$return_value = '<path d="M8 16c4.4 0 8-3.6 8-8s-3.6-8-8-8-8 3.6-8 8 3.6 8 8 8Zm0-1.2V1.2c3.8 0 6.8 3 6.8 6.8s-3 6.8-6.8 6.8Z"/>';
					break;

				case 'style' :

					$return_value = '<path d="M12.1 11.2c0-.7-.1-.6 0-1.4 0-.9 1.1-1.9 2.1.2.6 1.2 1.6.5 1.7-.1.3-1.9-.2-4.1-1.9-6.2C11.1 0 6-1.1 2.6 1.4c-3.4 2.4-3.4 8-.3 11.2 2.8 2.9 7 4.7 9.1 2.2 1-1.7.8-2.1.7-3.7ZM4.5 2.4c.6-.4 1.5-.3 1.9.3.5.6.3 1.5-.3 1.9-.6.4-1.5.3-1.9-.3s-.3-1.5.3-1.9ZM1.8 8.1c-.4-.6-.3-1.5.3-1.9.6-.5 1.5-.3 1.9.3.4.6.3 1.5-.3 1.9-.6.5-1.4.3-1.9-.3Zm6.6-3.7c-.4-.6-.3-1.5.3-1.9.6-.4 1.5-.3 1.9.3s.3 1.5-.3 1.9c-.6.5-1.5.3-1.9-.3Zm-4.6 7.2c-.4-.6-.3-1.5.3-1.9.6-.5 1.5-.3 1.9.3s.3 1.5-.3 1.9c-.6.5-1.4.3-1.9-.3Zm4.2-.2c.6-.4 1.5-.3 1.9.3s.3 1.5-.3 1.9c-.6.4-1.5.3-1.9-.3s-.3-1.5.3-1.9Z"/>';
					break;
